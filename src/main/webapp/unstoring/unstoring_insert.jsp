							...
							<div class="card-body">
								<div class="table-responsive">
									<table class="table table-bordered" id="dataTable" width="100%"
										...
										<tbody>
											<tr>
												<td><label for="unstoring_code">주문번호</label></td>
											...
											<tr>
												...
												<td><input name="manager_id" id="manager_id"
													type="text" required placeholder="ID 입력"></td>
											</tr>
											<tr>
												<td><label for="manager_id">담당자 PW</label></td>
												<td><input name="manager_pw" id="manager_pw"
													type="password" required placeholder="PW 입력"></td>
											</tr>
